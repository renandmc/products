		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Products",
									"targetURL": "#odatatutorialproducts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odatatutorialproducts-display": {
								"semanticObject": "odatatutorialproducts",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odata.tutorial.products",
									"url": sap.ui.require.toUrl("odata/tutorial/products")
								}
							}
						}
					}
